...
경제지:
한국경제, 매일경제, 서울경제, 머니투데이, 파이낸셜뉴스, 이데일리

IT/산업:
ZDNet Korea, 전자신문, 디지털데일리, 아이뉴스24, 블로터

- 단, 아래 조건이면 매체가 낮아도 유지 가능:
  1. 해당 매체만 보도한 단독 기사
  2. 다른 기사보다 추가 정보/해석이 있는 경우
  3. 특정 산업/전문 영역에서 의미 있는 기사

- 판단 기준:
  “이 기사를 제외하면 이슈 이해가 불완전해지는가?”
